...
import { q as j, a as H, s as A, t as T, B as q, v as z, c as $, e as K, b as M, u as D, w as Y, F as G, U as J } from "./index2.js";
...
const X = { class: "th-upsell-item" }, Z = { class: "th-upsell-item__wrapper" }, ee = {
    ...
    const { showUpsellModal: c } = j(), { t: r } = H(), e = P, v = h, m = k(!1), C = () => {
      ...
      if (e.item.title) {
        ...
        if (typeof l == "object" && window) {
          const d = (s = window.ticketHub) == null ? void 0 : s.language;
          let b = Object.values(l)[0];
          return typeof d < "u" && (b = l[d]), b;
        }
        return l;
      }
      return "";
    }, w = () => e.item.content && e.item.content.length;
    return _({ closeUpsellBooking: p }), (s, l) => (t(), n("div", X, [
      U("div", Z, [
        e.item.promoText || e.item.images || w() ? (t(), n("div", ee, [
          ...
          w() && !m.value ? (t(), n("button", {
            key: 2,
            class: "th-upsell-item__show-more-link",
            type: "button",
            onClick: l[0] || (l[0] = (d) => u(c)(e.item))
      ...
      m.value ? (t(), n(x, { key: 1 }, [
        ...
        w() ? (t(), n("button", {
          ...
          type: "button",
          onClick: l[1] || (l[1] = (d) => u(c)(e.item))
        }, f(u(r)("booking.showMore")), 1)) : a("", !0)
      ], 64)) : a("", !0)
    ]));
  }
}), ce = /* @__PURE__ */ $(ue, [["__scopeId", "data-v-71ebe529"]]), me = { class: "th-upsell-items" }, pe = {
  key: 0,
  ...
  setup(P) {
    ...
    S(async () => {
      var p, o;
      try {
        typeof ((p = window.ticketHub) == null ? void 0 : p.loaderComponent) < "u" && (v.value = (o = window.ticketHub) == null ? void 0 : o.loaderComponent);
        const i = await h.getUpsellItems();
        if (typeof i > "u" || i.length === 0)
          return await c.push({ name: L });
        let y = [];
        const w = i == null ? void 0 : i.map((s) => s.productId);
        y = await Y.getUpsells(w), r.value = i.map((s) => {
          let l = {
            price: 0,
            oldPrice: 0,
    ...
    const C = () => {
      var p;
      (p = e.value) == null || p.forEach(
        (o) => {
          o.closeUpsellBooking();
        }
      );
    };
    return (p, o) => (t(), n("div", me, [
      m.value ? (t(), n("div", pe, [
        (t(), g(F(v.value)))
...
}), _e = /* @__PURE__ */ $(de, [["__scopeId", "data-v-180a07be"]]), ve = /* @__PURE__ */ E({
  __name: "UpgradesView",
  setup(P) {
    const { t: _ } = H(), h = D(), c = M();
    S(async () => {
